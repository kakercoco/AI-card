...
<div class="news">
  ...
  <div class="news-list" v-for="i in 2" :key="i">
    <img src="@/assets/img/u112.png" alt="" class="emotion">
    <div class="title">
      <p><span class="name">Top-W</span><span class="tag">公司</span><span class="time">1小时前</span></p>
    </div>
    <div class="content clearfix">
      <p>生命诚可贵，生活价更高</p>
      <span v-for="(item, index) in list" :key="index" :class="{'img-one': list.length === 1}" class="img-wrap">
        <img :src="item.src" class="previewer-demo-img"  @click="show(index)">
      </span>
    </div>
    <div class="comment ">
      <div class="icon-time">
