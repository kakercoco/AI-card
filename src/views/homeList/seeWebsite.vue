 ...
 * @Last Modified time: 2018-09-01 15:36:00
 */
<template>
  <div class="see-card">
    <div class="title">
    ...
    <ul class="list">
      <li v-for="(item, index) in 5" :key="index">
        <p>2018-08-05 15:40</p>
        <img src="@/assets/img/u112.png" alt="">
        <div>T-cloud Man <i>翻阅</i>了你的<i>官方网站</i>，有可能对你比较感兴趣。</div>
...
<script>
import { XDialog, XButton, Group, Cell, Datetime } from 'vux'
