...
<template>
  <div class="insert-calendar">
    ...
    <group>
      <x-textarea title="日程标题:" v-model="title" :show-counter="true" :max="10" :rows="1" class='line-flex'></x-textarea>
    </group>
    <group>
...
export default {
  ...
  methods: {
    getUrl (i) {
      return `https://zhentuityun.71360.com/static/calendar/calendar${i +
        1}.png`
    },
    getCalendarTypeList () {
